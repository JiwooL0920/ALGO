...
# or not. An anagram is a word or phrase formed by rearranging the letters
...
def is_anagram(str1, str2):
    ...
    # sort the letters of the strings and then we have to compare the letters
    # with the same indexes; this is bottleneck because it has O(NlogN)
    str1 = sorted(str1)
    str2 = sorted(str2)
